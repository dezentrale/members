...
To run the whole application, use [Application.java](src/main/java/space/dezentrale/members/Application.java) as main class.
...
* [CreateController](docs/controllers/CreateController.md)
